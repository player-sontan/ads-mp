...
public class DataShieldDeleteTableVisitor extends FromItemVisitorAdapter {
    private final Delete parent;

    public DataShieldDeleteTableVisitor(Delete parent) {
        this.parent = parent;
    }
    ...
    public void visit(Table table) {
        ...
        adsManager.processDelete(table, () -> parent);
    }
}
