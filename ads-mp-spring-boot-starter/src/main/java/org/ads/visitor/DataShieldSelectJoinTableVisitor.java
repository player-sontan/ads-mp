...
public class DataShieldSelectJoinTableVisitor extends FromItemVisitorAdapter {
    ...
    public void visit(Table table) {
        ...
        SimpleNode parentNode = (SimpleNode) (table.getASTNode().jjtGetParent()).jjtGetParent();
        PlainSelect parentSelect = (PlainSelect) parentNode.jjtGetValue();

        adsManager.processSelect(table, () -> parentSelect);
    }
